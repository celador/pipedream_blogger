...
@CrewBase
class PipedreamSupportCrew():
	"""PipedreamSupport crew"""
	agents_config = 'config/agents.yaml'
	tasks_config = 'config/tasks.yaml'

	@agent
	def pipedream_support(self) -> Agent:
		return Agent(
			config=self.agents_config['pipedream_support'],
			tools=[docs_search, *pipedream_searchers, exa_client],
			verbose=True
		)
	...
	@crew
	def crew(self) -> Crew:
		"""Creates the PipedreamSupport crew"""
		return Crew(
