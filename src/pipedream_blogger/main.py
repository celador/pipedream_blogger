#!/usr/bin/env python
import sys
from pipedream_blogger.crew import PipedreamBloggerCrew
...
def run():
    ...
    """
    inputs = {
        'topic': 'AI Agent for Managing software teams',
    }
...
def replay():
    ...
    """
    try:
        PipedreamBloggerCrew().crew().replay(task_id=sys.argv[1])
...
def test():
    ...
    """
    inputs = {
        "AI Agent for Managing software teams"
    }
    try:
